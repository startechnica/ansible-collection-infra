...
| Percona Backup for MongoDB (PBM) | PBM agent status and base-backup list, using the deployment role's PBM control URI. | Only when `mongodb_pbm_enabled` is true. |
